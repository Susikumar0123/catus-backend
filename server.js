...
// ==========================================
// 2. VERIFY OTP & SET PASSWORD ROUTE (Fixed)
// ==========================================
...
app.post('/api/resend-otp', async (req, res) => {
    ...
    return res.json({ success: true, message: 'OTP resent successfully (Trial Mode)!' });
});
